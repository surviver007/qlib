...
<!-- 
> If you need to reproduce the results below, please use the **v1** dataset: `python scripts/get_base_data.py qlib_data --target_dir ~/.qlib/qlib_data/cn_data --region cn --version v1`
>
